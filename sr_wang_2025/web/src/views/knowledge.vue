...
<template>
  <el-card style="margin: 10px">
    <el-form ref="queryFormRef" :model="queryParams" :inline="true">
      ...
      <el-form-item label="类型" prop="typee" style="margin-bottom: 0">
        <el-select
          v-model="queryParams.typee"
          placeholder="请选择"
          clearable
          style="width: 200px"
        >
  ...
  <el-card style="margin: 10px">
    ...
    >
      ...
      <el-table-column label="类型" align="center" prop="typee" />
      <el-table-column
        label="标题"
        align="center"
        prop="title"
  ...
  >
    ...
    >
      <el-form-item label="类型" prop="typee">
        <el-select v-model="addFormData.typee" placeholder="请选择">
          <el-option
            v-for="item in options"
            :key="item.value"
            :label="item.label"
      ...
      <el-form-item label="标题" prop="title">
        <el-input v-model="addFormData.title" placeholder="请输入标题" />
      </el-form-item>
  ...
  >
    ...
    >
      <el-form-item label="类型" prop="typee">
        <el-select v-model="updateFormData.typee" placeholder="请选择">
          <el-option
            v-for="item in options"
            :key="item.value"
            :label="item.label"
      ...
      <el-form-item label="标题" prop="title">
        <el-input v-model="updateFormData.title" placeholder="请输入标题" />
      </el-form-item>
