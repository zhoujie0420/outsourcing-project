...
const rules = reactive({
  ...
  typee: [
    { required: true, message: "请输入类型，药品、店铺", trigger: "blur" },
  ],
});
...
<template>
  <el-card style="margin-top: 10px">
    <el-tabs tab-position="top" v-model="activeName" @tab-change="onTabChange">
      <el-tab-pane label="药品收藏" name="药品">
            ...
            <template #default="scope">
              <div style="display: flex; align-items: center; gap: 5px">
                ...
                <el-button
                  ...
                  link
                  size="small"
                  @click="openArticle(scope.row, '药品')"
                >
                  {{ scope.row.namee }}
                </el-button>
              </div>
      ...
      <el-tab-pane label="店铺收藏" name="店铺">
        <el-table v-loading="loading" :data="pageDataList">
          <el-table-column label="" align="left" prop="title">
            <template #default="scope">
              <div style="display: flex; align-items: center; gap: 5px">
                ...
                <el-button
                  ...
                  link
                  size="small"
                  @click="openArticle(scope.row, '店铺')"
                >
                  {{ scope.row.namee }}
                </el-button>
              </div>
